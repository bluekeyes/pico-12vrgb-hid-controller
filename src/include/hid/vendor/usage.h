...
enum {
    ...
    HID_USAGE_VENDOR_12VRGB_ANIMATION_TYPE              = 0x11,
    HID_USAGE_VENDOR_12VRGB_ANIMATION_PARAMETER         = 0x12,
    HID_USAGE_VENDOR_12VRGB_ANIMATION_COLOR_RED         = 0x13,
    HID_USAGE_VENDOR_12VRGB_ANIMATION_COLOR_GREEN       = 0x14,
    HID_USAGE_VENDOR_12VRGB_ANIMATION_COLOR_BLUE        = 0x15,
